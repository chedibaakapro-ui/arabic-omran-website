...
;
const metadata = {
    title: "عقار بلس | توقف عن تفويت الفرص العقارية الذهبية في السعودية",
    description: "احصل على المعلومات العقارية الحصرية قبل 6 أشهر من وصولها للعامة. مستثمرونا يربحون بمعدل 340% أكثر من السوق العام.",
    keywords: "عقار السعودية, استثمار عقاري, نيوم, القدية, أمالا, الرياض الجديدة, فرص عقارية",
    authors: [
        {
            name: "عقار بلس"
        }
    ...
    robots: "index, follow",
    openGraph: {
        title: "عقار بلس | توقف عن تفويت الفرص العقارية الذهبية",
        description: "مستثمرونا يربحون 340% أكثر من السوق العام. احصل على الوصول الحصري الآن.",
        url: "https://aqarplus.com",
        siteName: "عقار بلس",
        locale: "ar_SA",
        type: "website"
    },
    twitter: {
        ...
        title: "عقار بلس | الفرص العقارية الحصرية",
        description: "احصل على المعلومات قبل 6 أشهر من وصولها للعامة"
    }
};
